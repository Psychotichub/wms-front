...
const EmailVerificationScreen = () => {
  ...
  const verifyEmail = useCallback(async (token = null, code = null) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(data.message || tr('verification.failed'));
      }
      ...
      setError(err.message || tr('verification.genericError'));
      setIsVerified(false);
    } finally {
      setIsVerifying(false);
    }
  }, [apiUrl, setToken, setRefreshToken, setUser, tr]);
      ...
      >
        ...
        <View style={styles.headerSection}>
          ...
          <Text style={[styles.title, { color: t.colors.text }]}>
            {isVerified ? tr('verification.titleDone') : tr('verification.titlePending')}
          </Text>
          
          <Text style={[styles.subtitle, { color: t.colors.textSecondary }]}>
            {isVerified ? tr('verification.subtitleDone') : tr('verification.subtitlePending')}
          </Text>
        </View>
        ...
        {isVerified && (
          <View style={[styles.errorCard, { backgroundColor: t.colors.success + '20', borderColor: t.colors.success }]}>
            <View style={styles.errorRow}>
              ...
              <Text style={[styles.errorText, { color: t.colors.success }]}>{tr('verification.successBanner')}</Text>
            </View>
          </View>
        )}
          ...
          <View style={[styles.codeCard, { backgroundColor: t.colors.card, borderColor: t.colors.border }]}>
            ...
            <View style={[styles.codeInputWrapper, { 
              ...
              <TextInput
                ...
                placeholder={tr('verification.codePlaceholder')}
            ...
            <View style={styles.buttonContainer}>
              <Button
                title={isVerifying ? tr('verification.verifyingBtn') : tr('verification.verifyBtn')}
            ...
            {verificationToken && (
              <View style={styles.buttonContainer}>
                <Button
                  title={tr('verification.verifyWithLink')}
        ...
        {!isVerified && (
          <View style={[styles.resendCard, { backgroundColor: t.colors.card, borderColor: t.colors.border }]}>
            <View style={styles.resendHeader}>
              ...
              <Text style={[styles.resendTitle, { color: t.colors.text }]}>{tr('verification.resendTitle')}</Text>
            </View>
            <Text style={[styles.resendText, { color: t.colors.textSecondary }]}>{tr('verification.resendHint')}</Text>
            ...
            <View style={styles.emailInputContainer}>
              ...
              <View style={[styles.inputWrapper, { borderColor: t.colors.border, backgroundColor: t.colors.card }]}>
                ...
                <TextInput
                  ...
                  placeholder={tr('verification.emailPlaceholder')}
                  placeholderTextColor={t.colors.textSecondary}
                  value={email}
        ...
        <View style={styles.helpSection}>
          ...
          >
            ...
            <Text style={[styles.helpLinkText, { color: t.colors.primary }]}>{tr('verification.backToLogin')}</Text>
          </Pressable>
        </View>
      </ScrollView>
    </Screen>
