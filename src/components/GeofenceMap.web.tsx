            ...
            <>
              ...
              {geofenceData?.coordinates?.length > 0 && (
                <MarkerComponent
                  ...
                  title={geofenceName || tr('geofenceMap.geofence')}
                />
              )}
            </>
          )}
